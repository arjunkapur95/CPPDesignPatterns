...
public:
    ...
    void zoomIn(){m_distanceScale *= 0.9;}
    void zoomInOverloaded(){m_distanceScale *= 0.1;}

    //void zoomIn(){m_distanceScale *= 0.9;}

      //Zoom out
    void zoomOut(){ m_distanceScale *= 1.1;}

    void changeTimestepZoom() { m_physicsStepSize +=100000 ;}
    void changeTimestepZoomOut() { m_physicsStepSize -=100000 ;}

    void ViewAll()
    {
        m_distanceScale=m_distanceScale*9500;
    }
    void Reset()
    {
