#ifndef UNIVERSECOMPONENTVISITABLE_H
#define UNIVERSECOMPONENTVISITABLE_H

#include "universecomponent.h"
#include "universecomponentvisitor.h"


class UniverseComponentVisitable : public virtual UniverseComponent
{
public :


    UniverseComponentVisitable(
                                UniverseComponentType type,
                                const std::string &name,
                                const std::string &parentName)
    {}
    virtual ~UniverseComponentVisitable() { }
...
#endif // UNIVERSECOMPONENTVISITABLE_H
